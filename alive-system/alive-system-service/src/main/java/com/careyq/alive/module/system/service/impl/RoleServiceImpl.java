...
import com.careyq.alive.module.system.convert.RoleConvert;
...
import com.careyq.alive.module.system.mapper.RoleMapper;
import com.careyq.alive.module.system.mapper.RoleMenuMapper;
import com.careyq.alive.module.system.mapper.RoleUserMapper;
import com.careyq.alive.module.system.service.RoleService;
...
public class RoleServiceImpl extends ServiceImplX<RoleMapper, Role> implements RoleService {
    ...
    public Long saveRole(RoleDTO dto) {
        ...
        boolean exists = this.lambdaQueryX()
                ...
                .exists();
        if (exists) {
            throw new CustomException(SystemResultCode.ROLE_NAME_DUPLICATE);
        }
        if (dto.getId() != null) {
    ...
    public void changeDefault(Long id, Boolean isDefault) {
        ...
        if (Boolean.TRUE.equals(isDefault)) {
            ...
            if (!this.lambdaQuery().eq(Role::getIsDefault, true).ne(Role::getId, id).exists()) {
                throw new CustomException(SystemResultCode.ROLE_DEFAULT_NOT_EXISTS);
            }
        }
    ...
    private Role checkRoleExists(Long id) {
        ...
        if (role == null) {
            throw new CustomException(SystemResultCode.ROLE_NOT_EXISTS);
        }
        return role;
    }
